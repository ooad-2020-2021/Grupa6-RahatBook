...
namespace RahatBookAplikacija.Controllers
{
    public class AdministratorController : Controller
    {
        ...
        public AdministratorController(RahatBookContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,idLokacije,datumRodjenja,ime,prezime,status")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,idLokacije,datumRodjenja,ime,prezime,status")] Administrator administrator)
        {
